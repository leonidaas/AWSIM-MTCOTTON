AWSIM includes the following demo scenes.
...
|`MountCottonSimulationDemo.unity`|This is the Mount Cotton simulation scene connecting AWSIM and [Autoware](https://github.com/autowarefoundation/autoware) for self-driving.|
